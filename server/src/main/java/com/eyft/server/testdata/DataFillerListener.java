...
public class DataFillerListener implements ApplicationListener<DataFillingStartEvent> {
    ...
    public void onApplicationEvent(DataFillingStartEvent event) {
        if (isInitialized.compareAndSet(false, true)) {
            ...
            heroCreator.createEvent("Bilbo", "Bilbo Baggins' Birthday", "Dear Bilbo Baggins gets his 111th birthday and he suggests you to get together with his party!", "Hobbiton, Shire", Lists.newArrayList("Birthday", "Party", "Fireworks"), 1, 2, "BirthdayPreview.jpg");
            heroCreator.createEvent("Elrond", "Many Meetings", "The fellowship of the Ring is gathering here", "Rivendell, Misty Mountains", Lists.newArrayList("Ring", "Elves", "Mountains"), 30, 31, "ManyMeetingsPreview.jpg");
            heroCreator.createEvent("Saruman", "Orthanc Mess", "Saruman is waiting for you, Gandlalf The Gray...", "Orthanc, Isengard", Lists.newArrayList("Tower", "Orthanc", "Isengard", "Magic", "Mess"), 10, 13, "OrthancMeeting.jpg");
            heroCreator.createEvent("Saruman", "Meeting with Radagast", "Saruman wants to tell Radagast something.", "Orthanc, Isengard", Lists.newArrayList("Tower", "Orthanc", "Isengard"), 3, 5, "RadagastMeeting.jpg");
            heroCreator.createEvent("Gandalf", "A rogue job for Bilbo", "Bilbo is the best rogue in the Shire, isn't he?", "Hobbiton, Shire", Lists.newArrayList("Hobbiton", "Shire", "Job", "Gnomes"), 60, 61, "GandalfAndBilboMeeting.jpg");
