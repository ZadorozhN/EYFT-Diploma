            ...
            return <Col>
                <Card>
                    ...
                    <Card.Body>
                        ...
                        <Button color="outline-success" onClick={() => this.join(event.id)} className="mt-3" style={{ minWidth: "100%" }}>{dispense("join")} {event.price ? MoneyFormatter.format(event.price):dispense("free")}</Button>
                    </Card.Body>
...
export default withRouter(EventsToJoin);